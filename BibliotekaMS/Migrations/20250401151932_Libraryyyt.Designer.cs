...
namespace BibliotekaMS.Migrations
{
    ...
    [Migration("20250401151932_Libraryyyt")]
    partial class Libraryyyt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BibliotekaMS.Models.Ashensori", b =>
                {
                    b.Property<int>("AshensoriId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AshensoriId"));

                    b.Property<string>("Emri")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("NdertesaId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("AshensoriId");

                    b.HasIndex("NdertesaId");
            ...
            modelBuilder.Entity("BibliotekaMS.Models.Ndertesa", b =>
                {
                    b.Property<int>("NdertesaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("NdertesaId"));
            ...
            modelBuilder.Entity("BibliotekaMS.Models.Programi", b =>
                {
                    b.Property<int>("ProgramiID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ProgramiID"));
            ...
            modelBuilder.Entity("BibliotekaMS.Models.Universiteti", b =>
                {
                    b.Property<int>("UniversitetiID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("UniversitetiID"));

                    b.Property<string>("City")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("UniversitetiName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("UniversitetiID");

                    b.ToTable("Universiteti");
                });
            ...
            modelBuilder.Entity("BibliotekaMS.Models.Ashensori", b =>
                {
                    b.HasOne("BibliotekaMS.Models.Ndertesa", "Ndertesa")
                        .WithMany("Ashensori")
                        .HasForeignKey("NdertesaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Ndertesa");
                });
            ...
            modelBuilder.Entity("BibliotekaMS.Models.Programi", b =>
                {
                    b.HasOne("BibliotekaMS.Models.Universiteti", "Universiteti")
                        .WithMany("Programi")
